...
public class EventController {
    ...
    @PostMapping
    @Operation(summary = "Create a new event", description = "Create a new event", tags = {"Event Management System"})
    ...
    @PutMapping("/{id}")
    @Operation(summary = "Update an existing event", description = "Update an existing event", tags = {"Event Management System"})
    ...
    @GetMapping
    @Operation(summary = "Get all events", description = "Retrieve all events", tags = {"Event Management System"})
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "Delete an event", description = "Delete an event by ID", tags = {"Event Management System"})
