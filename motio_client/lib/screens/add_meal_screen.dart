...
class _AddMealScreenState extends ConsumerState<AddMealScreen> with TickerProviderStateMixin {
  ...
  Future<void> _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        final createdMeal = await _mealService.createMeal(newMeal);
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Błąd podczas dodawania posiłku: $e')),
        );
      } finally {
        setState(() {
          _isLoading = false;
